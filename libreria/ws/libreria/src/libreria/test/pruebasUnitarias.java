...
public class pruebasUnitarias {
	...
	public void crearLibro() {
		...
		// sin embargo, dará una excepcion puesto que el libro ya existe
	...
	public void crearRevista() {
		...
		// crearRevista() para que así lo guarde en el arreglo
		// listaTextosLiterarios[]
		...
		// sin embargo, dará una excepcion puesto que la revista ya existe
	...
	public void crearPeriodico() {
		...
		// arreglo, sin embargo, dará una excepcion puesto que el periodico ya
		// existe
